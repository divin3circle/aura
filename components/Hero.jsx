        ...
        <div className="relative flex-1 flex flex-col bg-pink-200 rounded-3xl xl:min-h-100 group">
          <div className="p-5 sm:p-16">
            ...
            <h2 className="text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-linear-to-r from-slate-600 to-[#c9cac9] bg-clip-text text-transparent max-w-xs  sm:max-w-md">
              Unleash Your Aura. Because Your Glow Matters.
            </h2>
            <div className="text-slate-800 text-sm font-medium mt-4 sm:mt-8">
              <p>Starts from</p>
              <p className="text-3xl">{currency}4.90</p>
            </div>
            <button className="bg-slate-800 text-white text-sm py-2.5 px-7 sm:py-5 sm:px-12 mt-4 sm:mt-10 rounded-xl hover:bg-slate-900 hover:scale-103 active:scale-95 transition">
              LEARN MORE
            </button>
          </div>
          <Image
